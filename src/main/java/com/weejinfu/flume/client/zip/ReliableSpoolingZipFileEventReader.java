...
import com.weejinfu.flume.serialization.ResettableZipInputStream;
import com.weejinfu.flume.serialization.ZipDeserializer;
import com.weejinfu.flume.source.SpoolDirectoryZipSourceConfigurationConstants;
import com.weejinfu.flume.source.SpoolDirectoryZipSourceConfigurationConstants.ConsumeOrder;
...
/**
 * Monitor target directory and read new zip file
 *
...
public class ReliableSpoolingZipFileEventReader implements ReliableEventReader {

    private static final Logger logger = LoggerFactory
            .getLogger(ReliableSpoolingZipFileEventReader.class);
    ...
    /**
     * Create a ReliableSpoolingZipFileEventReader to watch the given directory.
     */
    private ReliableSpoolingZipFileEventReader(File spoolDirectory,
        ...
        if (logger.isDebugEnabled()) {
            logger.debug("Initializing {} with directory={}, metaDir={}, " +
                            "deserializer={}",
                    new Object[] { ReliableSpoolingZipFileEventReader.class.getSimpleName(),
     ...
     * @param file
     * @return FileInfo for the file to consume or absent option if the
    ...
    private Optional<FileInfo> openFile(File file) {
        try {
            ...
            ResettableZipInputStream in =
                    new ResettableZipInputStream(file, tracker,
                            ResettableZipInputStream.DEFAULT_BUF_SIZE, inputCharset,
                            decodeErrorPolicy);
            EventDeserializer deserializer = EventDeserializerFactory.getInstance
                    (ZipDeserializer.Builder.class.getName(), deserializerContext, in);
            ...
            logger.error("Exception when create deserializer: " + deserializerType, fe);
            return Optional.absent();
        } catch (Exception e) {
    ...
    /**
     * Special builder class for ReliableSpoolingZipFileEventReader
     */
    public static class Builder {
        private File spoolDirectory;
        private String completedSuffix =
                SpoolDirectoryZipSourceConfigurationConstants.DEFAULT_SPOOLED_FILE_SUFFIX;
        private String ignorePattern =
                SpoolDirectoryZipSourceConfigurationConstants.DEFAULT_IGNORE_PAT;
        private String trackerDirPath =
                SpoolDirectoryZipSourceConfigurationConstants.DEFAULT_TRACKER_DIR;
        private Boolean annotateFileName =
                SpoolDirectoryZipSourceConfigurationConstants.DEFAULT_FILE_HEADER;
        private String fileNameHeader =
                SpoolDirectoryZipSourceConfigurationConstants.DEFAULT_FILENAME_HEADER_KEY;
        private Boolean annotateBaseName =
                SpoolDirectoryZipSourceConfigurationConstants.DEFAULT_BASENAME_HEADER;
        private String baseNameHeader =
                SpoolDirectoryZipSourceConfigurationConstants.DEFAULT_BASENAME_HEADER_KEY;
        private String deserializerType =
                SpoolDirectoryZipSourceConfigurationConstants.DEFAULT_DESERIALIZER;
        private Context deserializerContext = new Context();
        private String deletePolicy =
                SpoolDirectoryZipSourceConfigurationConstants.DEFAULT_DELETE_POLICY;
        private String inputCharset =
                SpoolDirectoryZipSourceConfigurationConstants.DEFAULT_INPUT_CHARSET;
        private DecodeErrorPolicy decodeErrorPolicy = DecodeErrorPolicy.valueOf(
                SpoolDirectoryZipSourceConfigurationConstants.DEFAULT_DECODE_ERROR_POLICY
                        .toUpperCase(Locale.ENGLISH));
        private ConsumeOrder consumeOrder =
                SpoolDirectoryZipSourceConfigurationConstants.DEFAULT_CONSUME_ORDER;
        ...
        public ReliableSpoolingZipFileEventReader build() throws IOException {
            return new ReliableSpoolingZipFileEventReader(spoolDirectory, completedSuffix,
